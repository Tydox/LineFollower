...
//initial Motor Speed----------------------------------------------------------------------------------------------
const byte INITIAL_MOTOR_SPEED=96;
int olderror=0;
...
void get_line_pos()
{
 ...
 Line_Position = (Line_Position * 10) + digitalRead(A1);
  ...
  switch (Line_Position)    {
    ...
    case 51000000:    {        error = -25;         break;    }
    case 51100000:    {        error = -26;         break;    }
    case 51110000:    {        error = -25;         break;    }
    ...
    case 50001110:    {        error = 4;          break;    }
    case 50000110:    {        error = 10;          break;    }
    case 50000111:    {        error = 25;          break;    }
    case 50000011:    {        error = 26;          break;    }
    case 50000001:    {        error = 25;          break;    }
 ...
 // if (error == 777 || error == SL || error == SR)  {  return;  }
  ...
  if (error == SL || error == SR)     
    { 
      ...
      {        set_direction('<');        set_speed(120, 120);        delay(100);        return;      }//left wheel needs to be a little faster

      if (error == SL)  //sharp turn left
      {        set_direction('>');        set_speed(120,120);        delay(100);        return;      } 
    ...
    if(error == 777 )
     {
       set_direction('F');
       set_speed(INITIAL_MOTOR_SPEED+5, INITIAL_MOTOR_SPEED);
       return;
       } 
...
void setup() {
  ...
  apds.setProximityIntHighThreshold(PROX_INT_HIGH); delay(100);
   ...
   tone(buzzer, 2000);   delay(50);   noTone(buzzer);
